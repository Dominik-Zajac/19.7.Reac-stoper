class Stopwatch extends React.Component {
    ...
    render() {
        ...
        return ( < div className = 'container' > < div className = 'stoper' > < div className = 'controls' > < a href = '#'
            className = 'button'
            id = 'buttonStart'
            onClick = {
                this.startAndStop.bind(this)
            } > {
                buttonLabel
            } < /a> < a href = '#'
            className = 'button'
            ...
            } > Reset < /a> < /div> < div className = 'stopwatch' > {
                format(this.state.times)
            } < /div> < /div> < ul className = "list"
            id = "results" > < /ul> < a href = '#'
            className = 'button'
            id = 'reset-list'
            onClick = {
